...
<input autofocus="true" aria-controls="place-suggestions-box" type="text">
</div>
...
export const factory = (suggest: Suggest<string>): Component => {
    ...
    const controller = searchBoxController<string>(suggest, ({suggestions: newSuggestions, isBusy, selectedSuggestion}) => {
    ...
    input.addEventListener('keydown', ev => {
        ...
        switch (key) {
            ...
            case 'Enter': {
                input.value = controller.selectedSuggestion;
