...
import { fetchPointsOfInterest, fetchPointsOfInterestFromAPI, fetchPointsOfInterestWithFailure, fetchPointsOfInterestWithSuccess, fetchSearchResult, fetchSearchResultFromAPI, fetchSearchResultWithFailure, fetchSearchResultWithSuccess, selectSearchResult } from '../../../src/app/actions/search';
export default (a) => {
    const { test } = a;
