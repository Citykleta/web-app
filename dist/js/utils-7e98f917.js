...
const formatDuration = (duration) => duration > 60 ? html `${Math.floor(duration / 60)}<span class="unit">min</span>` : html `${duration}<span class="unit">sec</span>`;
...
export { ActionType as A, LitElement as L, PropertyPart as P, Theme as T, commonjsGlobal as a, defaultState as b, createCommonjsModule as c, decodeLine as d, css as e, changeHistoryPoint as f, directive as g, html as h, AttributePart as i, debounce as j, formatDistance as k, formatDuration as l, createGeoCoord as m, once as o, polyline_1 as p, reducer as r, truncate as t };
//# sourceMappingURL=utils-7e98f917.js.map
